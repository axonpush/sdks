...
from ...models.transfer_ownership_input_body import TransferOwnershipInputBody
...
def _get_kwargs(
    org_id: str,
    *,
    body: TransferOwnershipInputBody,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/organizations/{org_id}/transfer-ownership".format(
