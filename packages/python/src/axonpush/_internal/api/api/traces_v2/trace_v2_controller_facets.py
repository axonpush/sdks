...
from ...models.trace_facets_v2_response_dto import TraceFacetsV2ResponseDto
from ...models.trace_v2_controller_facets_attr import TraceV2ControllerFacetsAttr
from ...models.trace_v2_controller_facets_attr_max import TraceV2ControllerFacetsAttrMax
from ...models.trace_v2_controller_facets_attr_min import TraceV2ControllerFacetsAttrMin
from ...models.trace_v2_controller_facets_res import TraceV2ControllerFacetsRes
...
def _get_kwargs(
    *,
    ...
    attr: TraceV2ControllerFacetsAttr | Unset = UNSET,
    attr_max: TraceV2ControllerFacetsAttrMax | Unset = UNSET,
    attr_min: TraceV2ControllerFacetsAttrMin | Unset = UNSET,
    ...
    res: TraceV2ControllerFacetsRes | Unset = UNSET,
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    if response.status_code == 200:
        response_200 = TraceFacetsV2ResponseDto.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[TraceFacetsV2ResponseDto]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Args:
        agent (str | Unset):
        app_id (str | Unset):
        attr (TraceV2ControllerFacetsAttr | Unset):
        attr_max (TraceV2ControllerFacetsAttrMax | Unset):
        attr_min (TraceV2ControllerFacetsAttrMin | Unset):
        ...
        query (str | Unset):
        release (str | Unset):
        res (TraceV2ControllerFacetsRes | Unset):
