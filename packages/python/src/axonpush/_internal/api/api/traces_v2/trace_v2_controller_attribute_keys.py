...
from ...models.trace_attribute_keys_v2_response_dto import TraceAttributeKeysV2ResponseDto
from ...models.trace_v2_controller_attribute_keys_attr import TraceV2ControllerAttributeKeysAttr
from ...models.trace_v2_controller_attribute_keys_attr_max import (
    TraceV2ControllerAttributeKeysAttrMax,
)
from ...models.trace_v2_controller_attribute_keys_attr_min import (
    TraceV2ControllerAttributeKeysAttrMin,
)
from ...models.trace_v2_controller_attribute_keys_res import TraceV2ControllerAttributeKeysRes
from ...models.trace_v2_controller_attribute_keys_scope import TraceV2ControllerAttributeKeysScope
...
def _get_kwargs(
    *,
    ...
    attr: TraceV2ControllerAttributeKeysAttr | Unset = UNSET,
    attr_max: TraceV2ControllerAttributeKeysAttrMax | Unset = UNSET,
    attr_min: TraceV2ControllerAttributeKeysAttrMin | Unset = UNSET,
    ...
    res: TraceV2ControllerAttributeKeysRes | Unset = UNSET,
    scope: TraceV2ControllerAttributeKeysScope | Unset = UNSET,
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    if response.status_code == 200:
        response_200 = TraceAttributeKeysV2ResponseDto.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[TraceAttributeKeysV2ResponseDto]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Args:
        agent (str | Unset):
        app_id (str | Unset):
        attr (TraceV2ControllerAttributeKeysAttr | Unset):
        attr_max (TraceV2ControllerAttributeKeysAttrMax | Unset):
        attr_min (TraceV2ControllerAttributeKeysAttrMin | Unset):
        ...
        query (str | Unset):
        release (str | Unset):
        res (TraceV2ControllerAttributeKeysRes | Unset):
        scope (TraceV2ControllerAttributeKeysScope | Unset):
