...
if TYPE_CHECKING:
    from ..models.action_evidence_dto import ActionEvidenceDto
...
T = TypeVar("T", bound="ActionDetailDto")
...
class ActionDetailDto:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for evidence_item_data in _evidence:
            evidence_item = ActionEvidenceDto.from_dict(evidence_item_data)
        ...
        action_detail_dto.additional_properties = d
        return action_detail_dto
