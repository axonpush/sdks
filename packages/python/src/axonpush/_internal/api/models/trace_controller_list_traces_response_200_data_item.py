...
T = TypeVar("T", bound="TraceControllerListTracesResponse200DataItem")


@_attrs_define
class TraceControllerListTracesResponse200DataItem:
    """
    Attributes:
        trace_id (str):
        event_count (float):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        return trace_controller_list_traces_response_200_data_item
