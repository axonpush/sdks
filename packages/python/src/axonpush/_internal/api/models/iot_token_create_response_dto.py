...
T = TypeVar("T", bound="IotTokenCreateResponseDto")


@_attrs_define
class IotTokenCreateResponseDto:
    """
    Attributes:
        ...
        organization_id (str):
        prefix (str):
        token (str): Raw IoT token, returned only once at creation time
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        iot_token_create_response_dto = cls(
        ...
        iot_token_create_response_dto.additional_properties = d
        return iot_token_create_response_dto
