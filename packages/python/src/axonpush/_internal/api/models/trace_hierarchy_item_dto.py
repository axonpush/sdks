...
if TYPE_CHECKING:
    from ..models.trace_hierarchy_item_dto_metadata import TraceHierarchyItemDtoMetadata
    from ..models.trace_hierarchy_item_dto_payload import TraceHierarchyItemDtoPayload


T = TypeVar("T", bound="TraceHierarchyItemDto")


@_attrs_define
class TraceHierarchyItemDto:
    """
    Attributes:
        active (bool):
        app_id (str):
        ...
        metadata (TraceHierarchyItemDtoMetadata | Unset):
        ...
        payload (TraceHierarchyItemDtoPayload | Unset):
    ...
    metadata: TraceHierarchyItemDtoMetadata | Unset = UNSET
    ...
    payload: TraceHierarchyItemDtoPayload | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        orphaned_parent = self.orphaned_parent
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        orphaned_parent = d.pop("orphanedParent")
        ...
        if isinstance(_metadata, Unset):
            ...
            metadata = TraceHierarchyItemDtoMetadata.from_dict(_metadata)
        ...
        if isinstance(_payload, Unset):
            ...
            payload = TraceHierarchyItemDtoPayload.from_dict(_payload)
        ...
        trace_hierarchy_item_dto.additional_properties = d
        return trace_hierarchy_item_dto
