...
if TYPE_CHECKING:
    from ..models.create_input_body_2_headers import CreateInputBody2Headers
...
class CreateInputBody2:
    ...
    Attributes:
        ...
        headers (CreateInputBody2Headers | Unset): Header name -> value map. Stored server-side, never returned.
    ...
    headers: CreateInputBody2Headers | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        headers: CreateInputBody2Headers | Unset
        if isinstance(_headers, Unset):
            headers = UNSET
        else:
            headers = CreateInputBody2Headers.from_dict(_headers)
